                 ...
                 int loanBookCount[], int countBook, char bookISBN[][20], char bookTitles[][100], int bookQuantities[], int &remainBooks)
{
    ...
    for (unsigned int j = 0; j < BorrowedBooks; j++)
    {
        ...
        if (i == -1)
        {
            ...
            if (i == -1)
            {
                cout << "Sach tim kiem khong ton tai.\n";
                return;
            }
        }
    ...
    cout << "Ngay: "; cin >> loanDates[countLoan][0];
    cout << "Thang: "; cin >> loanDates[countLoan][1];
    cout << "Nam: "; cin >> loanDates[countLoan][2];
                ...
                int countBook, char bookISBN[][20], int BookQuantites[], int bookPrices[], int &remainBooks)
{
    ...
    cout << "Ngay: "; cin >> returnDatesActual[LoanIndex][0];
    cout << "Thang: "; cin >> returnDatesActual[LoanIndex][1];
    cout << "Nam: "; cin >> returnDatesActual[LoanIndex][2];
    ...
    for (int j = 0; j < loanBookCount[LoanIndex]; j++)
    {
        ...
        if (lost == 1)
        {
            ...
            int fine = bookPrices[bookIndex] * 2 * loanBookQuanties[LoanIndex][j];
            totalFine += fine;
